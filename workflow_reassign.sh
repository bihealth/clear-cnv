...
#-w /fast/work/users/vmay_m/workflow/FCC/reassignment/run_002 \
#-r /fast/work/projects/cubit/18.12/static_data/reference/GRCh37/hs37d5/hs37d5.fa \
#-m /fast/work/users/vmay_m/workflow/FCC/reassignment/run_001/meta.tsv
#--cores 16

clearCNV workflow_untangle \
-w /fast/work/users/vmay_m/workflow/FCC/reassignment/run_001 \
-r /fast/work/projects/cubit/18.12/static_data/reference/GRCh37/hs37d5/hs37d5.fa \
-m /fast/work/users/vmay_m/workflow/FCC/reassignment/run_001/meta.tsv \
